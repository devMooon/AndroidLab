...
import com.example.myapplication11.databinding.Fragment22Binding
...
class MyAdapter2(val datas:MutableList<String>) : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return MyViewHolder2(ItemRecyclerviewBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
...
///////////제트팩라이브러리 2) fragment 화면 구성
        ...
        val binding = Fragment22Binding.inflate(inflater, container, false)
